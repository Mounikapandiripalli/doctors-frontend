...
function Doctorr() {
  ...
  const handleAddDoctor = (newDoctor) => {
    ...
    axios.post(' http://13.51.206.122:5000/doctors', newDoctor)
      .then((response) => {
  ...
  useEffect(() => {
    axios.get(' http://13.51.206.122:5000/doctors')
      .then((response) => {
  ...
  const handleDeleteDoctor = (doctorId) => {
    ...
    axios.delete(`http://13.51.206.122:5000/doctors/${doctorId}`)
      .then(() => {
  ...
  const handleEditDoctor = (editedDoctor) => {
    ...
    axios.put(`http://13.51.206.122:5000/doctors/${editedDoctor.id}`, editedDoctor)
      .then(() => {
